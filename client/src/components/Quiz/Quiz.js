        ...
        <Row>
          <Colxx xxs="12">
            <Card className="d-flex flex-row mb-3">
              <NavLink
                to={`/app/questions/${this.props.curentQuiz.id}`}
                className="d-flex"
              >
                <img
                  alt="Thumbnail"
              ...
              <div className="pl-2 d-flex flex-grow-1 min-width-zero">
                <div className="card-body align-self-center d-flex flex-column flex-lg-row justify-content-between min-width-zero align-items-lg-center">
                  ...
                  >
                    <p className="list-item-heading mb-1 truncate">
                      {this.props.curentQuiz.label}
                    </p>
                  </NavLink>
                  <p className="mb-1 text-muted text-small w-15 w-sm-100">
                    {this.props.curentQuiz.time} minutes
                  </p>
                  <p className="mb-1 text-muted text-small w-15 w-sm-100"></p>
                  <div className="w-15 w-sm-100">
                    <Link
                      to={`/app/play/${this.props.curentQuiz.id}`}
                      className="w-40 w-sm-100"
                    >
                ...
                <div className="custom-control custom-checkbox pl-1 align-self-center pr-4"></div>
              </div>
            </Card>
          </Colxx>
        </Row>

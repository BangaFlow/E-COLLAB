...
export default class uploadview extends Component {
  ...
  componentDidMount() {
    ...
    $(document).ready(function(){
      ...
      var access_token= "";
      var client_id = "254783341186-6kkeafblui7v0kpjcecsmm3dpmb3tadq.apps.googleusercontent.com"// replace it with your client id;
      ...
      $("#upload").on("click", function (e) {
          ...
          setTimeout(() => { history.push("/app/FileManagement/Files"); }, 1000);
              ...
              <Colxx xxs="12" className="mb-4">
                ...
                <InputGroup className="mb-3">
                  <InputGroupAddon addonType="prepend">
                    <Button outline color="secondary"  id="upload" onClick={(e) => this.setState({ isOpen: true })}>
                        Upload
                    </Button>
                  </InputGroupAddon>
                  <CustomInput

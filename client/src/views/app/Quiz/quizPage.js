...
import { Button, Container, Col, CardBody, CardTitle } from "reactstrap"
          ...
          <Col sm={{ size: 8, order: 2, offset: 2 }}>
            <CardBody className="center-block  ">
              <CardTitle className="mb-4 text-right">
                <h3 className="color-theme-1">
                  {time.minutes}:{time.seconds}
                  <span
                    color="danger"
                    className="iconsminds-clock center-block "
                  ></span>
                </h3>
              </CardTitle>
              ...
              <Button
                ...
                size="lg"
                id="optionA"
                hidden={this.state.currentQuestion.optionA === ""}
                block
                onClick={this.handleOptionClick}
                value={this.state.currentQuestion.optionA}
              >
              ...
              <Button
                ...
                size="lg"
                id="optionB"
                hidden={this.state.currentQuestion.optionB === ""}
                block
                onClick={this.handleOptionClick}
                value={this.state.currentQuestion.optionB}
              >
              ...
              <Button
                ...
                size="lg"
                id="optionC"
                hidden={this.state.currentQuestion.optionC === ""}
                block
                onClick={this.handleOptionClick}
                value={this.state.currentQuestion.optionC}
              >
              ...
              <Button
                ...
                size="lg"
                id="optionD"
                hidden={this.state.currentQuestion.optionD === ""}
                block
                onClick={this.handleOptionClick}
                value={this.state.currentQuestion.optionD}
              >
              ...
              <CardTitle className="mb-4 text-left">
                <h3 className="color-theme-1 ">
                  {this.state.nbOfAnsweredQuestion}/
                  {this.state.questions.length}
                  <span color="danger" className="iconsminds-pen"></span>
                </h3>
              </CardTitle>
              <CardTitle className="mb-4 text-center">
                <Button
                  outline
                  className="iconsminds-arrow-back-2"
                ...
                <Button
                  outline
                  className="iconsminds-arrow-next"
